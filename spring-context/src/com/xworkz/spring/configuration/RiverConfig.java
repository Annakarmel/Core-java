...
public class RiverConfig {
	...
	public String location() {
		...
		String ref3 = new String("Talakaveri");
		return ref3;
	}
	...
	public void id2() {
		...
		map.put("Kaveri", 100.3);
		map.put("Yamuna", 105.6);
		map.put("Tunga", 110.7);
		map.put("Malaprabha", 200.35);
		map.put("Ganga", 250.0);
