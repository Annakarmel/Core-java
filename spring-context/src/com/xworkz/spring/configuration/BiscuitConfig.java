...
public class BiscuitConfig {
	...
	public String type() {
		System.out.println("Registering location by string..");
		String ref4 = new String("Wrapper");
		return ref4;
	}
	...
	public void id2() {
		...
		map.put("20-20", 100.3);
		map.put("Gooday", 105.6);
		map.put("Parle-g", 110.7);
		map.put("Marie-gold", 200.35);
		map.put("Hide&Sick", 250.0);
