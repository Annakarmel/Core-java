...
public class ContryAndPresidentName {
	...
	public static void main(String[] args) {
		...
		List<String> val = country.values().stream().collect(Collectors.toList());
		val.stream().filter(e-> e.length() >= 10).collect(Collectors.toList()).forEach(e -> System.out.println(e));
		System.out.println("-----------------------------------------------");
