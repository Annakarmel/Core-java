...
public class ValentineController {
	...
	private List<String> places = Arrays.asList("Cubbon Park", "Lal Bagh", "Hebbal", "BTM", "Rajajinagar","Gayatri devi Park");
	private List<String> gifts = Arrays.asList("Teddy", "Watch", "Mobile", "Chocolate");
